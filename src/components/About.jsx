...
// NOTE: Copy below is placeholder. Replace bracketed/generic claims with
// facts you can stand behind before publishing (degrees, partnerships, etc).
const CREDENTIALS = [
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
        ...
        >
          ...
          <h2 className="font-display font-bold text-3xl sm:text-4xl leading-tight text-ink">
            ...
            <br />
            an <span className="font-accent italic font-medium text-volt">enabler</span> by choice
          </h2>
          ...
          <div className="mt-8 flex flex-col gap-3">
            {CREDENTIALS.map(({ icon: Icon, label }) => (
              <div key={label} className="flex items-center gap-3 text-sm text-ink/80">
        ...
        >
          <div className="rounded-2xl overflow-hidden aspect-4/5">
            <img
              src="/sean.jpeg"
              alt="Engineering contractor reviewing plans"
              className="w-full h-full object-cover"
            />
          </div>

          <div className="absolute -bottom-6 -left-6 bg-navy text-white rounded-2xl px-6 py-5 shadow-xl max-w-55px">
